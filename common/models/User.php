...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    /**
     * Finds trainer by password reset token
     *
    ...
    public static function isPasswordResetTokenValid($token)
    {
        ...
        $expire = Yii::$app->params['trainer.passwordResetTokenExpire'];
     ...
     * @return boolean if password provided is valid for current trainer
     */
