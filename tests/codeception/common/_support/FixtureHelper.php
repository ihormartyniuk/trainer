 ...
 * In this example, the database is populated with the demo login trainer, which is used in acceptance
...
class FixtureHelper extends Module
{
    ...
    /**
     * Method called before any suite tests run. Loads User fixture login trainer
