...
class PasswordResetRequestFormTest extends DbTestCase
{
    ...
    {
        $this->specify('no trainer with such email, message should not be sent', function () {
        ...
        $this->specify('trainer is not active, message should not be sent', function () {
    ...
    public function testSendEmailCorrectUser()
    {
        ...
        expect('trainer has valid token', $user->password_reset_token)->notNull();
    ...
    public function fixtures()
    {
        return [
            'trainer' => [
                ...
                'dataFile' => '@tests/codeception/frontend/unit/fixtures/data/models/trainer.php'
            ],
        ];
    }
